    ...
    <div style="background-color: rgb(241 245 249); padding: 50px;">
        <div style="border-radius: 10px; background-color: #ffffff;">
            ...
            <div style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
                <img style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;" src="https://raw.githubusercontent.com/YUND4/images/main/Screenshot%20from%202022-05-10%2010-57-03.png" alt="SGC">
            </div>
            <div class="text" style="padding: 0 2.5em; text-align: center;">
                ...
                <span>
                    <h4>RESPONSABLE</h4>
                    <p>{!! $uplan['person_assigned_name'] !!}</p>
                    <h4>DESCRIPCION</h4>
                    <p>{!! $uplan['goal_description'] !!}</p>
                </span>
