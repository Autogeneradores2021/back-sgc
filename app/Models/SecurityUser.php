...
class SecurityUser extends Model
{
    ...
    {
        $lastUserCreated = User::query()->where('role_code', '=', 'BOLSA')->orderBy('created_at', 'DESC')->first();
        ...
        Log::info('LA CONSULTA ARROJO '.$query->count().' RESULTADOS BASADO EN LA FECHA DE BUSQUEDA '.$lastUserCreated);
